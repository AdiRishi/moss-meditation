...
Many people want to meditate regularly, but commitment is difficult to maintain. Even the simple act of timing a session can work against the practice: phone alarms are abrupt, distracting, and designed to demand attention.

A meditation tool should not disturb the state it is meant to support.
...
Support the practice without becoming the focus of it.
...
Goals and progress should encourage commitment without creating guilt when life interrupts it.

### Gentle transitions

Starting and completing a session should feel calm and intentional. Sound, motion, and language should never be abrupt.

### Elegance with purpose

The interface should be simple, spacious, and immediately understandable. Every element must earn its place.
